...
func newThreshold(triggerType, thresholdType string, thresholdValue, higherLimit float64) *threshold {
	...
	if triggerType == moira2.RisingTrigger {
...
func getThresholdSeriesList(trigger *moira2.Trigger, theme moira2.PlotTheme, limits plotLimits) []chart.Series {
	thresholdSeriesList := make([]chart.Series, 0)
	if trigger.TriggerType == moira2.ExpressionTrigger {
...
func generateThresholds(trigger *moira2.Trigger, limits plotLimits) []*threshold {
...
func (threshold *threshold) generateThresholdSeries(theme moira2.PlotTheme, limits plotLimits) chart.TimeSeries {
