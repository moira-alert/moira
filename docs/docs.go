    ...
    "paths": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 100,
                        "description": "Number of items to return or all items if size == -1 (if size == -1 p should be zero for correct work)",
                        "name": "size",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "default": 0,
                        "description": "Defines the index of data portion (combined with size). E.g, p=2, size=100 will return records from 200 (including), to 300 (not including)",
                        "name": "p",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 100,
                        "description": "Number of items to be displayed on one page. if size = -1 then all events returned",
                        "name": "size",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        "type": "string",
                        "default": ".*",
                        "description": "Regular expression that will be used to filter events",
                        "name": "metric",
                        "in": "query"
                    },
                    {
                        ...
                        "description": "String of ',' separated state names. If empty then all states will be used.",
                        "name": "states",
                        "in": "query"
                    }
                ],
        ...
        "/tag": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Create tags successfully"
                    },
                    "400": {
                        "description": "Bad request from client",
                        "schema": {
        ...
        "/teams": {
            "get": {
                ...
                "operationId": "get-all-teams-for-user",
                "responses": {
                    "200": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "default": -1,
                        "description": "Number of items to be displayed on one page. if size = -1 then all teams returned",
                        "name": "size",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        "type": "string",
                        "default": ".*",
                        "description": "Regular expression which will be applied to team id or team name than filtering teams",
                        "name": "searchText",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "default": "asc",
                        "description": "String to set sort order (by name). On empty - no order, asc - ascending, desc - descending",
                        "name": "sort",
                        "in": "query"
                    }
                ],
        ...
        "/trigger/noisiness": {
            "get": {
                ...
                "operationId": "get-triggers-noisiness",
                "parameters": [
                    {
                        "type": "integer",
                        "default": 100,
                    ...
                    },
                    {
                        "type": "string",
                        "default": "desc",
                        "description": "String to set sort order (by events_count). On empty - no order, asc - ascending, desc - descending",
                        "name": "sort",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Get noisiness for triggers in range",
                        "schema": {
                            "$ref": "#/definitions/dto.TriggerNoisinessList"
                        }
                    },
                    "400": {
                        "description": "Bad request from client",
        ...
        "/trigger/unused": {
            "get": {
                ...
                "operationId": "get-unused-triggers",
                "responses": {
                    "200": {
                        "description": "Fetched unused triggers",
                        "schema": {
                            "$ref": "#/definitions/dto.TriggersList"
                        }
                    },
    ...
    "definitions": {
        ...
        "api.WebConfig": {
            ...
            "properties": {
                "contacts": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.WebContact"
                    }
                },
                "featureFlags": {
                ...
                "metric_source_clusters": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.MetricSourceCluster"
                    }
                },
                "remoteAllowed": {
                    "type": "boolean",
        ...
        "dto.Trigger": {
            ...
            "properties": {
                ...
                "cluster_id": {
                    "description": "Shows the exact cluster from where the metrics are fetched",
                    "type": "string",
                    "example": "default"
                },
                "created_at": {
                ...
                "trigger_source": {
                    "description": "Shows the type of source from where the metrics are fetched",
                    "type": "string",
        ...
        "dto.TriggerCheck": {
            ...
            "properties": {
                ...
                "last_successful_check_timestamp": {
                    "description": "LastSuccessfulCheckTimestamp - time of the last check of the trigger, during which there were no errors",
                    "type": "integer",
                    "format": "int64",
                    "example": 1590741916
                },
                ...
                "timestamp": {
                    "description": "Timestamp - time, which means when the checker last checked this trigger, this value stops updating if the trigger does not receive metrics",
                    "type": "integer",
                    "format": "int64",
                    "example": 1590741916
                },
        ...
        "dto.TriggerNoisiness": {
            ...
            "properties": {
                ...
                "events_count": {
                    "description": "EventsCount for the trigger.",
                    "type": "integer"
                },
                "expression": {
                    "description": "Used if you need more complex logic than provided by WARN/ERROR values",
        ...
        "dto.TriggerNoisinessList": {
            "type": "object",
            "properties": {
                "list": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.TriggerNoisiness"
                    }
                },
                "page": {
                    "type": "integer",
        ...
        "moira.MetricState": {
            ...
            "properties": {
                "deleted_but_kept": {
                    "description": "DeletedButKept controls whether the metric is shown to the user if the trigger has ttlState = Del\nand the metric is in Maintenance. The metric remains in the database",
                    "type": "boolean",
                    "example": false
                },
                "event_timestamp": {
