...
func GenerateThresholds(plot Plot, limits Limits, rising bool) []Threshold {
...
func (threshold Threshold) GenerateThresholdSeries(limits Limits, isRising bool) chart.TimeSeries {
...
func (threshold Threshold) GenerateAnnotationSeries(limits Limits, isRising bool, annotationFont *truetype.Font) chart.AnnotationSeries {
