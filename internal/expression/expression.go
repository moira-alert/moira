...
func (triggerExpression TriggerExpression) Get(name string) (interface{}, error) {
	switch name {
	case "OK":
		return moira2.StateOK, nil
	case "WARN", "WARNING":
		return moira2.StateWARN, nil
	case "ERROR":
		return moira2.StateERROR, nil
	case "NODATA":
		return moira2.StateNODATA, nil
	case "WARN_VALUE":
...
func (triggerExpression *TriggerExpression) Evaluate() (moira2.State, error) {
...
func getExpression(triggerExpression *TriggerExpression) (*govaluate.EvaluableExpression, error) {
	if triggerExpression.TriggerType == moira2.ExpressionTrigger {
