...
import (
	...
	mockMetricSource "github.com/moira-alert/moira/internal/mock/metric_source"
...
func TestResolveMetricsWindow(t *testing.T) {
	...
	localTrigger := moira2.TriggerData{ID: "redisTrigger", IsRemote: false}
	remoteTrigger := moira2.TriggerData{ID: "remoteTrigger", IsRemote: true}
	...
	Convey("ANY TRIGGER | Zero time range, force default time range", t, func() {
		allTriggers := []moira2.TriggerData{localTrigger, remoteTrigger}
