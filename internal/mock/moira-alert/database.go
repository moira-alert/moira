...
func (m *MockDatabase) AddNotification(arg0 *moira2.ScheduledNotification) error {
...
func (m *MockDatabase) AddNotifications(arg0 []*moira2.ScheduledNotification, arg1 int64) error {
...
func (m *MockDatabase) FetchNotificationEvent() (moira2.NotificationEvent, error) {
	ret := m.ctrl.Call(m, "FetchNotificationEvent")
	ret0, _ := ret[0].(moira2.NotificationEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDatabase) FetchNotifications(arg0 int64) ([]*moira2.ScheduledNotification, error) {
...
func (m *MockDatabase) GetAllContacts() ([]*moira2.ContactData, error) {
	ret := m.ctrl.Call(m, "GetAllContacts")
	ret0, _ := ret[0].([]*moira2.ContactData)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDatabase) GetContact(arg0 string) (moira2.ContactData, error) {
...
func (m *MockDatabase) GetContacts(arg0 []string) ([]*moira2.ContactData, error) {
...
func (m *MockDatabase) GetMetricsValues(arg0 []string, arg1, arg2 int64) (map[string][]*moira2.MetricValue, error) {
	ret := m.ctrl.Call(m, "GetMetricsValues", arg0, arg1, arg2)
	ret0, _ := ret[0].(map[string][]*moira2.MetricValue)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDatabase) GetNotificationEvents(arg0 string, arg1, arg2 int64) ([]*moira2.NotificationEvent, error) {
...
func (m *MockDatabase) GetNotifications(arg0, arg1 int64) ([]*moira2.ScheduledNotification, int64, error) {
...
func (m *MockDatabase) GetSubscription(arg0 string) (moira2.SubscriptionData, error) {
	ret := m.ctrl.Call(m, "GetSubscription", arg0)
	ret0, _ := ret[0].(moira2.SubscriptionData)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDatabase) GetSubscriptions(arg0 []string) ([]*moira2.SubscriptionData, error) {
...
func (m *MockDatabase) GetTagsSubscriptions(arg0 []string) ([]*moira2.SubscriptionData, error) {
...
func (m *MockDatabase) GetTrigger(arg0 string) (moira2.Trigger, error) {
	ret := m.ctrl.Call(m, "GetTrigger", arg0)
	ret0, _ := ret[0].(moira2.Trigger)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDatabase) GetTriggerChecks(arg0 []string) ([]*moira2.TriggerCheck, error) {
	ret := m.ctrl.Call(m, "GetTriggerChecks", arg0)
	ret0, _ := ret[0].([]*moira2.TriggerCheck)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDatabase) GetTriggerLastCheck(arg0 string) (moira2.CheckData, error) {
	ret := m.ctrl.Call(m, "GetTriggerLastCheck", arg0)
	ret0, _ := ret[0].(moira2.CheckData)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDatabase) GetTriggers(arg0 []string) ([]*moira2.Trigger, error) {
...
func (m *MockDatabase) NewLock(arg0 string, arg1 time.Duration) moira2.Lock {
	ret := m.ctrl.Call(m, "NewLock", arg0, arg1)
	ret0, _ := ret[0].(moira2.Lock)
	return ret0
}
...
func (m *MockDatabase) PushNotificationEvent(arg0 *moira2.NotificationEvent, arg1 bool) error {
...
func (m *MockDatabase) SaveContact(arg0 *moira2.ContactData) error {
...
func (m *MockDatabase) SaveMetrics(arg0 map[string]*moira2.MatchedMetric) error {
...
func (m *MockDatabase) SaveSubscription(arg0 *moira2.SubscriptionData) error {
...
func (m *MockDatabase) SaveSubscriptions(arg0 []*moira2.SubscriptionData) error {
...
func (m *MockDatabase) SaveTrigger(arg0 string, arg1 *moira2.Trigger) error {
...
func (m *MockDatabase) SetTriggerLastCheck(arg0 string, arg1 *moira2.CheckData, arg2 bool) error {
...
func (m *MockDatabase) SubscribeMetricEvents(arg0 *tomb_v2.Tomb) (<-chan *moira2.MetricEvent, error) {
	ret := m.ctrl.Call(m, "SubscribeMetricEvents", arg0)
	ret0, _ := ret[0].(<-chan *moira2.MetricEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
