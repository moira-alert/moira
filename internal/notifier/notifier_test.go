...
func TestUnknownContactType(t *testing.T) {
	...
	var eventsData moira2.NotificationEvents = []moira2.NotificationEvent{event}
...
func configureNotifier(t *testing.T) {
	...
	notif = NewNotifier(dataBase, logger, config, notifierMetrics, metricsSourceProvider, map[string]moira2.ImageStore{})
