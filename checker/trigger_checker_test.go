...
func TestInitTriggerChecker(t *testing.T) {
	...
	Convey("Test errors", t, func() {
		Convey("Get trigger error", func() {
			...
			_, err := MakeTriggerChecker(triggerID, dataBase, logger, config, metricSource.CreateMetricSourceProvider(localSource, nil, nil), &graphite.CheckerMetrics{})
	...
	Convey("Test trigger checker with lastCheck", t, func() {
		...
		actual, err := MakeTriggerChecker(triggerID, dataBase, logger, config, metricSource.CreateMetricSourceProvider(localSource, nil, nil), &graphite.CheckerMetrics{})
		So(err, ShouldBeNil)
