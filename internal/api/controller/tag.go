...
func GetAllTagsAndSubscriptions(database moira2.Database, logger moira2.Logger) (*dto.TagsStatistics, *api.ErrorResponse) {
...
func GetAllTags(database moira2.Database) (*dto.TagsData, *api.ErrorResponse) {
...
func getTagNamesSorted(database moira2.Database) ([]string, error) {
	tagsNames, err := database.GetTagNames()
	if err != nil {
		return nil, err
	}
...
func RemoveTag(database moira2.Database, tagName string) (*dto.MessageResponse, *api.ErrorResponse) {
