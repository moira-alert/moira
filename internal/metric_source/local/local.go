...
func Create(dataBase moira2.Database) metricSource.MetricSource {
...
func getPatternsMetricData(database moira2.Database, patterns []parser.MetricRequest, from int64, until int64, allowRealTimeAlerting bool) (map[parser.MetricRequest][]*types.MetricData, []string, error) {
