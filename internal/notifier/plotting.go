...
func resolveMetricsWindow(logger moira2.Logger, trigger moira2.TriggerData, pkg NotificationPackage) (int64, int64) {
	...
	fromTime, toTime := moira2.Int64ToTime(from), moira2.Int64ToTime(to)
...
func roundToRetention(unixTime int64) int64 {
	return moira2.RoundToNearestRetention(unixTime, defaultRetentionSeconds)
}

// evaluateTriggerMetrics returns collection of MetricData
func (notifier *StandardNotifier) evaluateTriggerMetrics(from, to int64, triggerID string) ([]*metricSource.MetricData, *moira2.Trigger, error) {
