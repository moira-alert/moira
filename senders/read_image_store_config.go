...
// is configured
func ReadImageStoreConfig(senderSettings map[string]interface{}, imageStores map[string]moira.ImageStore, logger moira.Logger) (string, moira.ImageStore, bool) {
	IimageStoreID, ok := senderSettings["image_store"]
	if !ok {
