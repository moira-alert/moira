...
var stateEmoji = map[moira2.State]string{
	moira2.StateOK:        okEmoji,
	moira2.StateWARN:      warnEmoji,
	moira2.StateERROR:     errorEmoji,
	moira2.StateNODATA:    nodataEmoji,
	moira2.StateEXCEPTION: exceptionEmoji,
	moira2.StateTEST:      testEmoji,
}
...
func (sender *Sender) buildMessage(events moira2.NotificationEvents, trigger moira2.TriggerData, throttled bool) string {
...
func (sender *Sender) buildDescription(trigger moira2.TriggerData) string {
	desc := trigger.Desc
	if trigger.Desc != "" {
...
func (sender *Sender) getStateEmoji(subjectState moira2.State) string {
	if sender.useEmoji {
