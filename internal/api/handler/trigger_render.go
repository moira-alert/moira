...
func evaluateTriggerMetrics(metricSourceProvider *metricSource.SourceProvider, from, to int64, triggerID string, fetchRealtimeData bool) ([]*metricSource.MetricData, *moira2.Trigger, error) {
...
func buildRenderable(request *http.Request, trigger *moira2.Trigger, metricsData []*metricSource.MetricData) (*chart.Chart, error) {
