...
func GetLoggerEntry(request *http.Request) moira2.Logger {
...
func RequestLogger(logger moira2.Logger) func(next http.Handler) http.Handler {
...
func newLogEntry(logger moira2.Logger, request *http.Request) *apiLoggerEntry {
