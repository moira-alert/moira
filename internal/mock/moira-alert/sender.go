...
func (m *MockSender) Init(arg0 map[string]string, arg1 moira2.Logger, arg2 *time.Location, arg3 string) error {
...
func (m *MockSender) SendEvents(arg0 moira2.NotificationEvents, arg1 moira2.ContactData, arg2 moira2.TriggerData, arg3 []byte, arg4 bool) error {
