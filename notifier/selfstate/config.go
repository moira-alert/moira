...
type Config struct {
	...
	ProtectorInspectOnly           bool
	ProtectorNumSamples            int
	ProtectorThrottling            int
	...
	ProtectorSampleRatio           float64
	ProtectorSampleRetention       time.Duration
	ProtectorMechanism             string
