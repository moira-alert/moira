...
// GetNotifierMessage mocks base method
func (m *MockDatabase) GetNotifierMessage() (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNotifierMessage")
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetNotifierMessage indicates an expected call of GetNotifierMessage
func (mr *MockDatabaseMockRecorder) GetNotifierMessage() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNotifierMessage", reflect.TypeOf((*MockDatabase)(nil).GetNotifierMessage))
}
...
// SetNotifierMessage mocks base method
func (m *MockDatabase) SetNotifierMessage(arg0 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetNotifierMessage", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetNotifierMessage indicates an expected call of SetNotifierMessage
func (mr *MockDatabaseMockRecorder) SetNotifierMessage(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetNotifierMessage", reflect.TypeOf((*MockDatabase)(nil).SetNotifierMessage), arg0)
}
