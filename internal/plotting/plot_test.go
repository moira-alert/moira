...
var plotsHashDistancesTestCases = []plotsHashDistancesTestCase{
	{
		...
		triggerType:        moira2.ExpressionTrigger,
		warnValue:          nil,
		errorValue:         nil,
	...
	},
	{
		...
		plotTheme:          "dark",
		useHumanizedValues: true,
		triggerType:        moira2.FallingTrigger,
		stateOk:            true,
...
func renderTestMetricsDataToPNG(trigger moira2.Trigger, plotTheme string,
