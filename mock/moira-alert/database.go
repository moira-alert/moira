...
func (m *MockDatabase) GetGraphiteChecksUpdatesCount() (int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDatabaseMockRecorder) GetGraphiteChecksUpdatesCount() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetGraphiteChecksUpdatesCount", reflect.TypeOf((*MockDatabase)(nil).GetGraphiteChecksUpdatesCount))
}
...
func (m *MockDatabase) SetTriggerLastCheck(arg0 string, arg1 *moira.CheckData, arg2 string) error {
	m.ctrl.T.Helper()
