...
type Notifier interface {
	...
	RegisterSender(senderSettings map[string]string, sender moira2.Sender) error
	StopSenders()
...
func NewNotifier(database moira2.Database, logger moira2.Logger, config Config, metrics *metrics.NotifierMetrics, metricSourceProvider *metricSource.SourceProvider, imageStoreMap map[string]moira2.ImageStore) *StandardNotifier {
...
func (notifier *StandardNotifier) runSender(sender moira2.Sender, ch chan NotificationPackage) {
