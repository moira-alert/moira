...
import (
	...
	"github.com/moira-alert/moira/internal/senders/discord"
	"github.com/moira-alert/moira/internal/senders/mail"
	"github.com/moira-alert/moira/internal/senders/msteams"
	"github.com/moira-alert/moira/internal/senders/opsgenie"
	"github.com/moira-alert/moira/internal/senders/pagerduty"
	"github.com/moira-alert/moira/internal/senders/pushover"
	"github.com/moira-alert/moira/internal/senders/script"
	"github.com/moira-alert/moira/internal/senders/selfstate"
	"github.com/moira-alert/moira/internal/senders/slack"
	"github.com/moira-alert/moira/internal/senders/telegram"
	"github.com/moira-alert/moira/internal/senders/twilio"
	"github.com/moira-alert/moira/internal/senders/victorops"
	"github.com/moira-alert/moira/internal/senders/webhook"
...
func (notifier *StandardNotifier) RegisterSenders(connector moira2.Database) error {
	var err error
...
func (notifier *StandardNotifier) RegisterSender(senderSettings map[string]string, sender moira2.Sender) error {
...
func (notifier *StandardNotifier) runSenders(sender moira2.Sender, eventsChannel chan NotificationPackage) {
