...
var (
	fakeTriggerToIndex = &moira2.TriggerCheck{
...
func (index *Index) fillIndex() error {
	...
	index.triggerIndex.Write([]*moira2.TriggerCheck{fakeTriggerToIndex})
	defer index.triggerIndex.Delete([]string{fakeTriggerToIndex.ID})
