...
func BenchmarkUnpackMetricsValues(b *testing.B) {
	...
	metricsValues := make([]*moira2.MetricValue, 0)

	for i := from + retention; i <= until; i += retention {
		metricsValues = append(metricsValues, &moira2.MetricValue{
			RetentionTimestamp: int64((i / retention) * retention),
			Timestamp:          int64(i),
			Value:              float64(i),
		})
	}
	metricData := map[string][]*moira2.MetricValue{"metric1": metricsValues}
...
func TestFetchData(t *testing.T) {
	...
	dataList := map[string][]*moira2.MetricValue{
		metric: {
			{
	...
	dataList[metric2] = []*moira2.MetricValue{
		{
			RetentionTimestamp: 20,
			Timestamp:          23,
			Value:              0,
...
func TestAllowRealTimeAlerting(t *testing.T) {
	metricsValues := []*moira2.MetricValue{
		{
			RetentionTimestamp: 20,
			Timestamp:          23,
			Value:              0,
...
func TestConservativeAlignedSeries(t *testing.T) {
	var retention int64 = 10
	var from int64
	metricData := map[string][]*moira2.MetricValue{"metric": make([]*moira2.MetricValue, 0)}
	...
	Convey("Time == 0", t, func() {
		...
		Convey("Has Metric Values", func() {
			metricData["metric"] = []*moira2.MetricValue{
				{
	...
	metricData["metric"] = append(metricData["metric"], &moira2.MetricValue{Timestamp: 10, RetentionTimestamp: 10, Value: 200.00})
	metricData["metric"] = append(metricData["metric"], &moira2.MetricValue{Timestamp: 20, RetentionTimestamp: 20, Value: 300.00})
...
func TestConservativeMultipleSeries(t *testing.T) {
	var retention int64 = 10
	var from int64
	metricData := map[string][]*moira2.MetricValue{
		"metric1": make([]*moira2.MetricValue, 0),
		"metric2": make([]*moira2.MetricValue, 0),
	}
	...
	Convey("Time == 0", t, func() {
		...
		metricData["metric1"] = append(metricData["metric1"], &moira2.MetricValue{Timestamp: 0, RetentionTimestamp: 0, Value: 100.00})
	...
	metricData["metric2"] = append(metricData["metric2"], &moira2.MetricValue{Timestamp: 5, RetentionTimestamp: 5, Value: 150.00})
	...
	metricData["metric1"] = append(metricData["metric1"], &moira2.MetricValue{Timestamp: 10, RetentionTimestamp: 10, Value: 200.00})
	metricData["metric2"] = append(metricData["metric2"], &moira2.MetricValue{Timestamp: 15, RetentionTimestamp: 15, Value: 250.00})
	metricData["metric1"] = append(metricData["metric1"], &moira2.MetricValue{Timestamp: 20, RetentionTimestamp: 20, Value: 300.00})
	...
	metricData["metric2"] = append(metricData["metric2"], &moira2.MetricValue{Timestamp: 25, RetentionTimestamp: 25, Value: 350.00})
...
func TestNonZeroStartTimeSeries(t *testing.T) {
	...
	Convey("Time == 11", t, func() {
		...
		metricData["metric"] = append(metricData["metric"], &moira2.MetricValue{Timestamp: 11, RetentionTimestamp: 10, Value: 100.00})
...
func TestConservativeShiftedSeries(t *testing.T) {
	...
	metricData["metric"] = append(metricData["metric"], &moira2.MetricValue{Timestamp: 4, RetentionTimestamp: 0, Value: 100.00})
	...
	metricData["metric"] = append(metricData["metric"], &moira2.MetricValue{Timestamp: 15, RetentionTimestamp: 10, Value: 200.00})
	metricData["metric"] = append(metricData["metric"], &moira2.MetricValue{Timestamp: 25, RetentionTimestamp: 20, Value: 300.00})
