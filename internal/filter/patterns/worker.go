...
func NewRefreshPatternWorker(database moira2.Database, metrics *metrics.FilterMetrics, logger moira2.Logger, patternStorage *filter.PatternStorage) *RefreshPatternWorker {
