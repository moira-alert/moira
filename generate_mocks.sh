...
mockgen -destination=mock/moira-alert/delivery_checker_database.go -package=mock_moira_alert github.com/moira-alert/moira/datatypes DeliveryCheckerDatabase
