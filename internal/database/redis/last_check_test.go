...
func TestLastCheckErrorConnection(t *testing.T) {
	...
	Convey("Should throw error when no connection", t, func() {
		...
		So(actual1, ShouldResemble, moira2.CheckData{})
		...
		So(actual2, ShouldResemble, moira2.CheckData{})
		So(err, ShouldNotBeNil)
	})
}
...
func TestMaintenanceUserSave(t *testing.T) {
	...
	Convey("Check user saving for metric maintenance", t, func() {
		checkData := lastCheckTest
		triggerID := uuid.Must(uuid.NewV4()).String()
		checkData.MaintenanceInfo = moira2.MaintenanceInfo{}
		userLogin := "test"
...
var lastCheckWithNoMetrics = moira2.CheckData{
	Score:     0,
	State:     moira2.StateOK,
	Timestamp: 1504509981,
...
var lastCheckWithNoMetricsWithMaintenance = moira2.CheckData{
	Score:       0,
	State:       moira2.StateOK,
	Timestamp:   1504509981,
	Maintenance: 1000,
