...
var (
	...
	testTemplate = fmt.Sprintf("%s/%s/%s/%s/%s", testHost, moira2.VariableTriggerID, moira2.VariableContactType, moira2.VariableContactID, moira2.VariableContactValue)
	...
	testEvents      = []moira2.NotificationEvent{
...
var requestURLTestCases = []requestURLTestCase{
	{
		trigger: moira2.TriggerData{ID: "triggerID"},
		contact: moira2.ContactData{Type: "contactType", ID: "contactID", Value: "contactValue"},
		results: map[string]string{
			testTemplate: "https://hostname.domain/triggerID/contactType/contactID/contactValue",
		},
	},
	{
		trigger: moira2.TriggerData{ID: testBadID},
		contact: moira2.ContactData{Type: "contactType", ID: "contactID", Value: "contactValue"},
		results: map[string]string{
			testTemplate: "https://hostname.domain/%21@%23$/contactType/contactID/contactValue",
			fmt.Sprintf("%s/%s/%s/%s", testHost, moira2.VariableContactType, moira2.VariableContactID, moira2.VariableContactValue): "https://hostname.domain/contactType/contactID/contactValue",
		},
	},
	{
		trigger: moira2.TriggerData{ID: testBadID},
		contact: moira2.ContactData{Type: testBadID, ID: "contactID", Value: "contactValue"},
		results: map[string]string{
			testTemplate: "https://hostname.domain/%21@%23$/%21@%23$/contactID/contactValue",
			fmt.Sprintf("%s/%s/%s", testHost, moira2.VariableContactID, moira2.VariableContactValue): "https://hostname.domain/contactID/contactValue",
		},
	},
	{
		trigger: moira2.TriggerData{ID: testBadID},
		contact: moira2.ContactData{Type: testBadID, ID: testBadID, Value: "contactValue"},
		results: map[string]string{
			testTemplate: "https://hostname.domain/%21@%23$/%21@%23$/%21@%23$/contactValue",
			fmt.Sprintf("%s/%s", testHost, moira2.VariableContactValue): "https://hostname.domain/contactValue",
		},
	},
	{
		trigger: moira2.TriggerData{ID: testBadID},
		contact: moira2.ContactData{Type: testBadID, ID: testBadID, Value: testBadID},
		results: map[string]string{
...
func TestBuildRequestBody(t *testing.T) {
	Convey("Payload should be valid", t, func() {
		...
		Convey("Empty notification", func() {
			events, contact, trigger, plot, throttled := moira2.NotificationEvents{}, moira2.ContactData{}, moira2.TriggerData{}, make([]byte, 0), false
			requestBody, err := buildRequestBody(events, contact, trigger, plot, throttled)
