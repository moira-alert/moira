...
type TagsData struct {
	TagNames []string `json:"list" example:"cpu" binding:"required"`
}
...
type MessageResponse struct {
	Message string `json:"message" example:"tag deleted" binding:"required"`
}
...
type TagsStatistics struct {
	List []TagStatistics `json:"list" binding:"required"`
}

type TagStatistics struct {
	TagName       string                   `json:"name" example:"cpu" binding:"required"`
	Triggers      []string                 `json:"triggers" example:"bcba82f5-48cf-44c0-b7d6-e1d32c64a88c" binding:"required"`
