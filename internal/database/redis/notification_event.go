...
func (connector *DbConnector) GetNotificationEvents(triggerID string, start int64, size int64) ([]*moira2.NotificationEvent, error) {
...
func (connector *DbConnector) PushNotificationEvent(event *moira2.NotificationEvent, ui bool) error {
...
func (connector *DbConnector) FetchNotificationEvent() (moira2.NotificationEvent, error) {
	c := connector.pool.Get()
	defer c.Close()
